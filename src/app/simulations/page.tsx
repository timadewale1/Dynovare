          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6">
              ...
              <Button
                ...
                onClick={() => router.push("/policies/upload?redirect=/simulations")}
              >
                <Upload size={16} />
                Upload policy
              </Button>
    ...
    <ProtectedRoute>
      <DashboardLayout>
        ...
        <Card className="p-6 mb-6">
          ...
          <p className="text-sm text-[var(--text-secondary)] mb-4">
            Configure assumptions and horizon. Dynovare will estimate impacts and risks (MVP model).
          </p>
